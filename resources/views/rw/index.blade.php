                    ...
                    @foreach($rw as $data)
                      <tr>
                        ...
                        <form action="{{route('rw.destroy', $data->id)}}" method="post">
                                @csrf
                                @method('DELETE')
                                <td><a class="btn btn-primary btn-sm" href="{{route('rw.show', $data->id)}}"><i class='fas fa-eye'></i></a>|
                                <a class="btn btn-warning btn-sm" href="{{route('rw.edit', $data->id)}}"><i class='fas fa-edit'></i> </a>|
